...
[x] **Nota:** Cada bucle de iteración recuperará los datos retornados por los métodos  y almacenará o operará con ellos de acuerdo al procedimiento que se esté ejecutando.